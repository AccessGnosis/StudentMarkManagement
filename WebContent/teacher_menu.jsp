...
String kind=(String)session.getAttribute("kind");
 %>
    <table width="1024" height="661" bgcolor="#1fa0eb" align="center" cellspacing="0" cellpadding="0"><tr><td><div align="center">  
    </div><table width="1024" height="660" bgcolor="#ffffff" align="center" cellspacing="0" cellpadding="0">
    <tr><td><table width="1016" height="652" bgcolor="#8dd8f8" align="center">
    <tr height="100"><td></td></tr>
     <tr><td><form name="changecode" action="menu_slt?id=<%=id %>&kind=<%=kind %>" method="post" onsubmit="return isValid(this);"><table align="center" border="1">
