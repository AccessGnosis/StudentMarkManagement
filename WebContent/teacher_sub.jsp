...
<html>
  ...
  <body>
   ...
   <tr><td height="35" align="center" background="image/bgpicture.gif"><font color="#0000ff"><strong><a href="teacher_sub_cl.jsp?tid=<%=tid %>&con=subing" target="main">未提交课程</a></strong></font></td></tr>
   ...
   <tr><td height="10" ><font color="#0000ff"><br></font></td></tr>
   <tr><td height="35" align="center" background="image/bgpicture.gif"><font color="#0000ff"><strong><a href="teacher_sub_cl.jsp?tid=<%=tid %>&con=subed" target="main">已提交课程</a></strong></font></td></tr>
   <tr><td height="10" ><font color="#0000ff"><br></font></td></tr>
   <tr><td height="35" align="center" background="image/bgpicture.gif"><font color="#0000ff"><strong><a href=".jsp" target="main"></a></strong></font></td></tr>
