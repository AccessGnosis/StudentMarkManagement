...
<html>
  ...
  String kind=(String)session.getAttribute("kind");
	...
	<ul class="TabBarLevel1" id="TabPage1">
		...
		<li id="Tab2"><a target="mainframe" href="student_sel.jsp" onclick="javascript:switchTab('TabPage1','Tab2');">&nbsp;&nbsp;&nbsp;&nbsp;<strong>信 息 查 询</strong>&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
		...
		<li id="Tab4"><a target="mainframe" href="student_lyb.jsp" onclick="javascript:switchTab('TabPage1','Tab4');">&nbsp;&nbsp;&nbsp;<strong>我 要 留 言</strong>&nbsp;&nbsp;&nbsp;</a></li>
